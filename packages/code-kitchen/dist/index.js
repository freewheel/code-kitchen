...
var circularShallowEqual = createComparator(
...
function urlJoin(url, ...args) {
  ...
  const u = new URL(
    url,
    (_a = globalThis.location) == null ? void 0 : _a.origin
  );
...
function useMonaco() {
  const [monaco, setMonaco] = (0, import_react.useState)(_cached_monaco);
  (0, import_react.useEffect)(() => {
    if (!_monacoInitialized) {
      _monacoInitialized = (async () => {
        var _a;
        import_loader.default.config({
          paths: {
            vs: urlJoin(globalConfig.monacoEditorPath, "vs"),
          },
        });
        const _monaco =
          (_a = import_loader.default.__getMonacoInstance()) != null
            ? _a
            : await import_loader.default.init();
...
function useModels(id, files) {
  ...
  const modelsRef = (0, import_react2.useRef)(null);
  const [_, setCounter] = (0, import_react2.useState)(0);
...
function useMonacoEditor(id, ref, files, onChange, activeFileName) {
  ...
  const stateCacheRef = (0, import_react2.useRef)(/* @__PURE__ */ new Map());
  (0, import_react2.useEffect)(() => {
  ...
  (0, import_react2.useEffect)(() => {
    ...
    const activeModel =
      models == null
        ? void 0
        : models.find((m) => m.uri.path.endsWith(activeFileName));
    if (
      editor &&
      activeModel &&
...
function FilesEditor({ id, initialFiles, files, onChange }) {
  const filenames = files.filter((f) => !f.hidden).map((f) => f.filename);
  const [activeTab, setActiveTab] = (0, import_react2.useState)(filenames[0]);
  const editorWrapperRef = (0, import_react2.useRef)(null);
  const filesRef = (0, import_react2.useRef)(files);
  import_react2.default.useEffect(() => {
    filesRef.current = files;
  });
  const onFileChange = (0, import_react2.useCallback)(
    (newCode, filename) => {
      const newFiles = [...filesRef.current];
      const idx = newFiles.findIndex((f) => f.filename === filename);
      if (idx !== -1) {
        newFiles[idx] = __spreadProps(__spreadValues({}, newFiles[idx]), {
          code: newCode,
        });
      }
      onChange(newFiles);
  ...
  const doReset = (0, import_react2.useCallback)(() => {
...
var RotateToHorizontalIcon = (props) =>
...
var RotateToVerticalIcon = (props) =>
  /* @__PURE__ */ React3.createElement(
    ...
    render() {
      ...
      return /* @__PURE__ */ import_react3.default.createElement(
        ...
        typeof Element === "function"
          ? /* @__PURE__ */ import_react3.default.createElement(Element, null)
          : Element
      );
    }
  };
...
var generatePreviewComponent = (id, { input, scope = {} }, errorCallback) => {
  try {
    const _module = {
      exports: {},
    };
    evalCode(
      input,
      __spreadProps(__spreadValues({}, scope), {
...
var usePreviewComponent = (id, files, require2) => {
  const [bundling, setBundling] = import_react3.default.useState(false);
  const [Preview, setPreview] = import_react3.default.useState(null);
  ...
  import_react3.default.useEffect(() => {
    return () => {
      var _a;
      (_a = document.querySelector(`[data-code-kitchen-style-id="${id}"]`)) ==
      null
        ? void 0
        : _a.remove();
    };
    ...
    /* @__PURE__ */ React5.createElement(
      ...
      /* @__PURE__ */ React5.createElement(
        ...
        /* @__PURE__ */ React5.createElement(
          ...
          /* @__PURE__ */ React5.createElement(ControlButton, {
            icon: !showCode
              ? /* @__PURE__ */ React5.createElement(ShowCodeIcon, null)
              : /* @__PURE__ */ React5.createElement(HideCodeIcon, null),
            onClick: () => setShowCode((c) => !c),
          }),
          /* @__PURE__ */ React5.createElement(ControlButton, {
            icon: !fullScreen
              ? /* @__PURE__ */ React5.createElement(FullscreenIcon, null)
              : /* @__PURE__ */ React5.createElement(ExitFullscreenIcon, null),
      ...
      /* @__PURE__ */ React5.createElement(
        ...
        error &&
          /* @__PURE__ */ React5.createElement(
            ...
            /* @__PURE__ */ React5.createElement("pre", null, error.toString())
          ),
        /* @__PURE__ */ React5.createElement(
          "div",
          {
          ...
          bundling && !Preview
            ? "loading..."
            : Preview && /* @__PURE__ */ React5.createElement(Preview, null)
        )
      ),
      error &&
        /* @__PURE__ */ React5.createElement(
          ...
          /* @__PURE__ */ React5.createElement(ErrorIcon, null)
        )
    ),
    showCode &&
      /* @__PURE__ */ React5.createElement(FilesEditor, {
        id,
        initialFiles,
        files,
        onChange: setFiles,
